...
BOOT_LOGO = e959_oq_s70_63_p0_hdplus1560
BUILD_KERNEL = yes
BUILD_LK = yes
BUILD_MD32 = no
BUILD_MTK_SDK =
...
FINGERPRINT_MICROARRAY_TRUSTKERNEL_TEE = yes
FINGERPRINT_MICROARRAY_REE = no
...
# CAMERA HAL KERNEL
CUSTOM_HAL_IMGSENSOR = s5k4h7yx_mipi_raw imx214_mipi_raw imx135_mipi_raw gc5025_mipi_raw gc0310_mipi_yuv gc032a_mipi_yuv
CUSTOM_HAL_MAIN_IMGSENSOR = imx214_mipi_raw imx135_mipi_raw
CUSTOM_HAL_MAIN_BACKUP_IMGSENSOR =
CUSTOM_HAL_SUB_IMGSENSOR = s5k4h7yx_mipi_raw gc5025_mipi_raw gc032a_mipi_yuv
CUSTOM_HAL_SUB_BACKUP_IMGSENSOR =
CUSTOM_HAL_MAIN2_IMGSENSOR = gc0310_mipi_yuv
CUSTOM_HAL_CAM_CAL =
ODM_CAM_SUPPORT_RATIO = imx214_mipi_raw 

CUSTOM_KERNEL_IMGSENSOR = s5k4h7yx_mipi_raw imx214_mipi_raw imx135_mipi_raw gc5025_mipi_raw gc0310_mipi_yuv gc032a_mipi_yuv
CUSTOM_KERNEL_MAIN_IMGSENSOR = imx214_mipi_raw imx135_mipi_raw
CUSTOM_KERNEL_MAIN_BACKUP_IMGSENSOR =
CUSTOM_KERNEL_SUB_IMGSENSOR = s5k4h7yx_mipi_raw gc5025_mipi_raw gc032a_mipi_yuv
CUSTOM_KERNEL_SUB_BACKUP_IMGSENSOR =
CUSTOM_KERNEL_MAIN2_IMGSENSOR = gc0310_mipi_yuv
CUSTOM_KERNEL_MAIN2_BACKUP_IMGSENSOR =
CUSTOM_KERNEL_CAM_CAL = 
ODM_FEATURE_FAKE_MAIN2_CAMERA_SUPPORT=yes

# AF LENS HAL KERNEL
CUSTOM_HAL_LENS = dw9714a dummy_lens dw9718af fp5510af dw9714caf
CUSTOM_HAL_MAIN_LENS = dw9714a dw9718af fp5510af dw9714caf
CUSTOM_HAL_MAIN_BACKUP_LENS = 
CUSTOM_HAL_SUB_LENS = dummy_lens
CUSTOM_HAL_SUB_BACKUP_LENS = 

CUSTOM_KERNEL_LENS = dw9714a dummy_lens dw9718af fp5510af dw9714caf
CUSTOM_KERNEL_MAIN_LENS = dw9714a dw9718af fp5510af dw9714caf
...
WTK_BUILD_VERNO = OUKITEL_C17 Pro_V7.0_20190828
WTK_INTERNAL_BUILD_VERNO = E959_OQ_S70_63_P0_V1.6.3.1_S190828

#End For Common----------------------------------------------------------}
MTK_SOUNDRECORDER_APP = yes
#add by zhiheng.huang for OdmFileManager start
ODM_FILEMANAGER_APP = yes
#add by zhiheng.huang for OdmFileManager end

# A: Bug_id:add Flashlight. chenchunyong 20190124 {
...
WTK_DEFAULT_BLUETOOTH_NAME = C17 Pro
WTK_PTP_LABEL = C17 Pro
WTK_MTP_LABEL = C17 Pro
WTK_PICTURE_MAKER = OUKITEL
#FACE_UNLOCK_SUPPORT start
FACE_UNLOCK_SUPPORT = true
FACE_OUKI_NO_ICON = yes
FACE_TRUSTKERNEL_TEE_SUPPORT = yes

#add by wuzhi.peng for livedisplay
WTK_LIVE_DISPLAY_SUPPORT = yes
#add by wuzhi.peng for livedisplay
#adupsfota start
...
#add for wtk ota diff tool start
WTK_OTA_DIFF_TOOL = no
#add for wtk ota diff tool end

# A: Bug_id:EJWJ-46 chenchunyong 20190603 {
WTK_QRCODE_SUPPORT = yes
# A: }

# A: Bug_id:add gangyun bokeh. chenchunyong 20181207 {
GANGYUN_BOKEH_SUPPORT = yes
# A: }

#add gang.liu eea start
HOME_BUTTON_ANIMATION_SUPPORT=yes
#add gang.liu eea end

#Cyee feature start
ODM_CYEEFRAMEWORK_SUPPORT = yes
CYEE_FLASHLIGHT_SUPPORT = yes
ODMCALCULATOR_SUPPORT = yes
CYEE_NOTE_SUPPORT = yes
WTK_GALLERY2_SUPPORT = no
CYEE_DIALER_INCALL_CONTACTS = yes
#Cyee feature end

# Modify by HZH on 2019/6/13 for EWWQ-1116 start
WTK_TARGET_BOARD_NAME = E959
# Modify by HZH on 2019/6/13 for EWWQ-1116 end
#add gang.liu eea start
HOME_BUTTON_ANIMATION_SUPPORT=yes
#add gang.liu eea end
#add by peng.zhao for camera_cts 20190610 start
WTK_CAMERA_COVERED_SWITCH =yes
WTK_MAIN2_CTS_SUPPORT = yes
#add by peng.zhao for camera_cts 20190610 end

WTK_INSTALL_CYEE_LAUNCHER = yes

#add by liulei for CyeeSystemUI 20190702 start
SUPPORT_CYEE_SYSTEMUI = yes
#add by liulei for CyeeSystemUI 20190702 end

# add by wangjian for EJWJ-626 20190807 start
WTK_SMART_NAVIBAR_SUPPORT = yes
# add by wangjian for EJWJ-626 20190807 end
